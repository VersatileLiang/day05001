...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header layui-bg-blue">
        ...
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item"><a>已发送</a></li>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-bg-cyan layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="javascript:;">查看所有邮件</a>
                    <dl class="layui-nav-child" lay-filter="demo">
                        <dd onclick=""><a href="javascript:;">查看所有</a></dd>
                        <dd onclick=""><a href="javascript:;">删除邮件</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body">
        ...
        <table class="layui-table" lay-data="{ height:500, url:'/day05001/getAllEmails.do', page:true, id:'idTest'}" lay-filter="demo">
            <thead>
            <tr>
                <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                <th lay-data="{field:'t_id', width:180, sort: true, fixed: true}">email_id</th>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
                layer.confirm('邮件id：'+ data.t_id + '<br>' +
                    ...
                    layer.confirm('真的要把这个邮件删除掉么', function(index){
